    ...
    def mock_request_impl(*args, **kwargs):
        ...
        if url.endswith("threads"):
            ...
            data = {
                ...
                "threads_count": 1, # active_threads
                "comments_count": 2 # active_threads
            }
        if data:
...
class UserProfileTestCase(ModuleStoreTestCase):
    ...
    def get_response(self, mock_request, params, **headers):
        mock_request.side_effect = make_mock_request_impl("userprofile", "dummy_thread_id")
    ...
    def check_html(self, mock_request, **params):
        ...
        self.assertRegexpMatches(html, r'&quot;id&quot;: &quot;dummy_thread_id&quot;')
        self.assertRegexpMatches(html, r'&quot;title&quot;: &quot;userprofile&quot;')
    ...
    def check_ajax(self, mock_request, **params):
        ...
        self.assertEqual(response_data['discussion_data'][0]['id'], "dummy_thread_id")
        self.assertEqual(response_data['discussion_data'][0]['title'], "userprofile")
        self.assertEqual(response_data['discussion_data'][0]['body'], "userprofile")
